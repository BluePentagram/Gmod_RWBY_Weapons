...
function EFFECT:Init( data )
	...
	for i = 1,1 do
		...
		if particle == nil then particle = emitter:Add( "vgui/rwbyeffect/effect_rosepetal", Pos + Vector(   math.random(-16,16),math.random(-10,10),math.random(0,64) ) ) end
		...
		if (particle) then
			...
			particle:SetColor(math.random(72,255),math.random(0,9),math.random(0,9),math.random(255,255))
